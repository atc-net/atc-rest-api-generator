...
namespace Demo.Api.Generated.Contracts.Users
{
    ...
    public class UpdateUserByIdResult : ResultBase
    {
        ...
        /// </summary>
        public static UpdateUserByIdResult BadRequest(string? message = null) => new UpdateUserByIdResult(ResultFactory.CreateContentResultWithValidationProblemDetails(HttpStatusCode.BadRequest, message));
        ...
        /// </summary>
        public static UpdateUserByIdResult Conflict(object? error = null) => new UpdateUserByIdResult(ResultFactory.CreateContentResultWithProblemDetails(HttpStatusCode.Conflict, error));
