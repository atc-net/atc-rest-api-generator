...
public class GetUserByIdResult : ResultBase
{
    ...
    /// </summary>
    public static GetUserByIdResult Conflict(object? error = null) => new GetUserByIdResult(ResultFactory.CreateContentResultWithProblemDetails(HttpStatusCode.Conflict, error));
