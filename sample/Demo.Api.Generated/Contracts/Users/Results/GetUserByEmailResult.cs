...
namespace Demo.Api.Generated.Contracts.Users
{
    ...
    public class GetUserByEmailResult : ResultBase
    {
        ...
        /// </summary>
        public static GetUserByEmailResult Conflict(object? error = null) => new GetUserByEmailResult(ResultFactory.CreateContentResultWithProblemDetails(HttpStatusCode.Conflict, error));
