...
namespace Demo.Api.Generated.Contracts.Files
{
    ...
    public interface IUploadFileAsFormDataHandler
    {
        /// <summary>
        /// Execute method.
        /// </summary>
        ...
        Task<UploadFileAsFormDataResult> ExecuteAsync(UploadFileAsFormDataParameters parameters, CancellationToken cancellationToken = default);
    }
}