    ...
    public override string ToString()
        ...
        var propertyParameters = new List<PropertyParameters>
        {
            new(
                ...
                Attributes: new List<AttributeParameters> { new("FromRoute", "Name = \"accountId\""), new("Required", null) },
                AccessModifier: AccessModifiers.Public,
                GenericTypeName: null,
                TypeName: "Guid",
                Name: "AccountId",
            ...
            new(
                ...
                Attributes: new List<AttributeParameters> { new("FromHeader", "Name = \"name\"") },
                AccessModifier: AccessModifiers.Public,
                GenericTypeName: null,
                TypeName: "string",
                Name: "Name",
    ...
    public async Task<ActionResult> SetAccountName(
        ...
        var methodParameters = new List<MethodParameters>
        {
            new(
                ...
                {
                    new(null, null, "UpdateAccountNameParameters", "parameters", null),
                    new(new List<AttributeParameters> { new("FromServices", null) }, null, "IUpdateAccountNameHandler", "handler", null),
                    new(null, null, "CancellationToken", "cancellationToken", null),
                },
            ...
            new(
                ...
                Parameters: new List<ParameterBaseParameters>
                {
                    new(null, null, "SetAccountNameParameters", "parameters", null),
                    new(new List<AttributeParameters> { new("FromServices", null) }, null, "ISetAccountNameHandler", "handler", null),
                    new(null, null, "CancellationToken", "cancellationToken", null),
                },
                UseExpressionBody: true,
                Content: "await handler.ExecuteAsync(parameters, cancellationToken)"),
    ...
    public static implicit operator UpdateAccountNameResult(string response)
        ...
        var methodParameters = new List<MethodParameters>
        {
            new(
                ...
                Name: "Ok",
                Parameters: new List<ParameterBaseParameters> { new(null, null, "string?", "message", "null") },
                UseExpressionBody: true,
            ...
            new(
                ...
                Parameters: new List<ParameterBaseParameters> { new(null, null, "string", "response", null) },
                UseExpressionBody: true,
                Content: "Ok(response)"),
        };
