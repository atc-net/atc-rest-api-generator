...
public class GetSponsoredChargePointEndpointResult : EndpointResponse, IGetSponsoredChargePointEndpointResult
{
    public GetSponsoredChargePointEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
