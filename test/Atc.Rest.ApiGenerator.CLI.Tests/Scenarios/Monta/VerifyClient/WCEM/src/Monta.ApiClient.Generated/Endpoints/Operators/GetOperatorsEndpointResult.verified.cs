...
public class GetOperatorsEndpointResult : EndpointResponse, IGetOperatorsEndpointResult
{
    public GetOperatorsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageOperatorDto OkContent
        => IsOk && ContentObject is MontaPageOperatorDto result
            ? result
