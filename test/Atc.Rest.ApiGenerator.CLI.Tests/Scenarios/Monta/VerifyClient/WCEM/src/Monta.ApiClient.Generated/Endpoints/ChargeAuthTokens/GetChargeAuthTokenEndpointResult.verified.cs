...
public class GetChargeAuthTokenEndpointResult : EndpointResponse, IGetChargeAuthTokenEndpointResult
{
    public GetChargeAuthTokenEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
