...
public class CreateChargeAuthTokenEndpointResult : EndpointResponse, ICreateChargeAuthTokenEndpointResult
{
    public CreateChargeAuthTokenEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
