...
public class GetChargePointBrandsEndpointResult : EndpointResponse, IGetChargePointBrandsEndpointResult
{
    public GetChargePointBrandsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageChargePointBrandDto OkContent
        => IsOk && ContentObject is MontaPageChargePointBrandDto result
            ? result
