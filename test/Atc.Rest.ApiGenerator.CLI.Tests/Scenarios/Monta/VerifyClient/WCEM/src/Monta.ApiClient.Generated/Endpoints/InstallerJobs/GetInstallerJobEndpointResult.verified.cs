...
public class GetInstallerJobEndpointResult : EndpointResponse, IGetInstallerJobEndpointResult
{
    public GetInstallerJobEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public InstallerJob OkContent
        => IsOk && ContentObject is InstallerJob result
            ? result
