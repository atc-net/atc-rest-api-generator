...
public class PostSponsoredChargePointEndpointResult : EndpointResponse, IPostSponsoredChargePointEndpointResult
{
    public PostSponsoredChargePointEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
