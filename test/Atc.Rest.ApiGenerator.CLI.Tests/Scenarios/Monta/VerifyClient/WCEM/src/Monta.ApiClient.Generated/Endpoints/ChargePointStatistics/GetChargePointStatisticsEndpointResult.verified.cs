...
public class GetChargePointStatisticsEndpointResult : EndpointResponse, IGetChargePointStatisticsEndpointResult
{
    public GetChargePointStatisticsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public ChargePointStatisticsDto OkContent
        => IsOk && ContentObject is ChargePointStatisticsDto result
            ? result
