...
public class GetInvoice1EndpointResult : EndpointResponse, IGetInvoice1EndpointResult
{
    public GetInvoice1EndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public InvoiceDto OkContent
        => IsOk && ContentObject is InvoiceDto result
            ? result
