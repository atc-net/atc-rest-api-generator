...
public class PatchPriceGroupTagEndpoint : IPatchPriceGroupTagEndpoint
{
    private readonly IHttpClientFactory factory;
    private readonly IHttpMessageFactory httpMessageFactory;

    public PatchPriceGroupTagEndpoint(
    ...
    public async Task<PatchPriceGroupTagEndpointResult> ExecuteAsync(
        PatchPriceGroupTagParameters parameters,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await responseBuilder.BuildResponseAsync(x => new PatchPriceGroupTagEndpointResult(x), cancellationToken);
    }
}