...
public class UnblockChargeAuthTokenEndpointResult : EndpointResponse, IUnblockChargeAuthTokenEndpointResult
{
    public UnblockChargeAuthTokenEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
