...
public class GetChargePointOcppLogsEndpoint : IGetChargePointOcppLogsEndpoint
{
    private readonly IHttpClientFactory factory;
    private readonly IHttpMessageFactory httpMessageFactory;

    public GetChargePointOcppLogsEndpoint(
    ...
    public async Task<GetChargePointOcppLogsEndpointResult> ExecuteAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var requestBuilder = httpMessageFactory.FromTemplate("/api/v1/charge-points/{chargePointId}/logs");
        ...
        responseBuilder.AddSuccessResponse<MontaPageChargePointOcppLogDto>(HttpStatusCode.OK);
        ...
        return await responseBuilder.BuildResponseAsync(x => new GetChargePointOcppLogsEndpointResult(x), cancellationToken);
    }
}