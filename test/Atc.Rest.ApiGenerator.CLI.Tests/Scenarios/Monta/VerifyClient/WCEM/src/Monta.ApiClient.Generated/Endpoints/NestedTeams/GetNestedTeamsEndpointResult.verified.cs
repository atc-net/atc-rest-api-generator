...
public class GetNestedTeamsEndpointResult : EndpointResponse, IGetNestedTeamsEndpointResult
{
    public GetNestedTeamsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageNestedTeamDto OkContent
        => IsOk && ContentObject is MontaPageNestedTeamDto result
            ? result
