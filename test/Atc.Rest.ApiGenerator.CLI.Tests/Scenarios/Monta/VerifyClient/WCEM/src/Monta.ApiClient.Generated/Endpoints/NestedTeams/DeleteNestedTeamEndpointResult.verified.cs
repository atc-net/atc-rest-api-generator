...
public class DeleteNestedTeamEndpointResult : EndpointResponse, IDeleteNestedTeamEndpointResult
{
    public DeleteNestedTeamEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
