...
public class AcceptInviteEndpoint : IAcceptInviteEndpoint
{
    ...
    public async Task<AcceptInviteEndpointResult> ExecuteAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var requestBuilder = httpMessageFactory.FromTemplate("/api/v1/nested-teams/{relationId}/accept-invite");
        ...
        return await responseBuilder.BuildResponseAsync(x => new AcceptInviteEndpointResult(x), cancellationToken);
    }
}