...
public class GetWalletTransactionsEndpointResult : EndpointResponse, IGetWalletTransactionsEndpointResult
{
    public GetWalletTransactionsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageWalletTransactionDto OkContent
        => IsOk && ContentObject is MontaPageWalletTransactionDto result
            ? result
