...
public class CreateSubscriptionEndpointResult : EndpointResponse, ICreateSubscriptionEndpointResult
{
    public CreateSubscriptionEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
