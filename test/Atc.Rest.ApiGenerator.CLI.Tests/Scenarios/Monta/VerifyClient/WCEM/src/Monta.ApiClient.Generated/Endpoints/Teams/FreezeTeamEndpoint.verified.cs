...
public class FreezeTeamEndpoint : IFreezeTeamEndpoint
{
    private readonly IHttpClientFactory factory;
    private readonly IHttpMessageFactory httpMessageFactory;

    public FreezeTeamEndpoint(
    ...
    public async Task<FreezeTeamEndpointResult> ExecuteAsync(
        FreezeTeamParameters parameters,
        string httpClientName = "Monta-ApiClient",
        CancellationToken cancellationToken = default)
    {
        var client = factory.CreateClient(httpClientName);

        var requestBuilder = httpMessageFactory.FromTemplate("/api/v1/teams/{id}/freeze");
        ...
        return await responseBuilder.BuildResponseAsync(x => new FreezeTeamEndpointResult(x), cancellationToken);
    }
}