...
public class UpdateNestedTeamEndpointResult : EndpointResponse, IUpdateNestedTeamEndpointResult
{
    public UpdateNestedTeamEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public NestedTeam OkContent
        => IsOk && ContentObject is NestedTeam result
            ? result
