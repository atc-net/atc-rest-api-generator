...
public class GetOperatorEndpointResult : EndpointResponse, IGetOperatorEndpointResult
{
    public GetOperatorEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public Operator OkContent
        => IsOk && ContentObject is Operator result
            ? result
