...
public class DeletePriceGroupEndpointResult : EndpointResponse, IDeletePriceGroupEndpointResult
{
    public DeletePriceGroupEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
