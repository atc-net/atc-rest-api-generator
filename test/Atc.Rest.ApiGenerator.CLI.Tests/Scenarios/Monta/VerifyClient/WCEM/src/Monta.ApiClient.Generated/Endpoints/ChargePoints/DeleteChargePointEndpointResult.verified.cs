...
public class DeleteChargePointEndpointResult : EndpointResponse, IDeleteChargePointEndpointResult
{
    public DeleteChargePointEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
