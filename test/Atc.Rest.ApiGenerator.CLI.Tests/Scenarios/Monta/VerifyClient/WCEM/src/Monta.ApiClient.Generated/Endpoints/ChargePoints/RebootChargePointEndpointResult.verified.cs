...
public class RebootChargePointEndpointResult : EndpointResponse, IRebootChargePointEndpointResult
{
    public RebootChargePointEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
