...
public class GetInsightsChargesChargeAuthTokenReportEndpointResult : EndpointResponse, IGetInsightsChargesChargeAuthTokenReportEndpointResult
{
    public GetInsightsChargesChargeAuthTokenReportEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageChargesInsightByChargeAuthTokenReportDto OkContent
        => IsOk && ContentObject is MontaPageChargesInsightByChargeAuthTokenReportDto result
            ? result
