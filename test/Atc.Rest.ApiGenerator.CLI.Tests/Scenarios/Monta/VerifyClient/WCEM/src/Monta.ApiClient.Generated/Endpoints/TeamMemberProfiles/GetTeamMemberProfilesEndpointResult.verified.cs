...
public class GetTeamMemberProfilesEndpointResult : EndpointResponse, IGetTeamMemberProfilesEndpointResult
{
    public GetTeamMemberProfilesEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageTeamMemberProfileDto OkContent
        => IsOk && ContentObject is MontaPageTeamMemberProfileDto result
            ? result
