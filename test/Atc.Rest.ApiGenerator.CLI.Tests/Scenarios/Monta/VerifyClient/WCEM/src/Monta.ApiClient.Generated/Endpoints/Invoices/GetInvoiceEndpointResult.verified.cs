...
public class GetInvoiceEndpointResult : EndpointResponse, IGetInvoiceEndpointResult
{
    public GetInvoiceEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageInvoiceDto OkContent
        => IsOk && ContentObject is MontaPageInvoiceDto result
            ? result
