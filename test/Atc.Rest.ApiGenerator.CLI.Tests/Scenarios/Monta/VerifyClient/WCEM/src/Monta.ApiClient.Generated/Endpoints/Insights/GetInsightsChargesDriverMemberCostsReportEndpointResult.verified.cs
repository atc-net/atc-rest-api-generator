...
public class GetInsightsChargesDriverMemberCostsReportEndpointResult : EndpointResponse, IGetInsightsChargesDriverMemberCostsReportEndpointResult
{
    public GetInsightsChargesDriverMemberCostsReportEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageChargesInsightDriverMemberCostsReportDto OkContent
        => IsOk && ContentObject is MontaPageChargesInsightDriverMemberCostsReportDto result
            ? result
