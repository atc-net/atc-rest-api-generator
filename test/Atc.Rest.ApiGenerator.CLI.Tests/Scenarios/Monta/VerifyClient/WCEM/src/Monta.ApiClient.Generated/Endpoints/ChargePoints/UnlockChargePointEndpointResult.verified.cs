...
public class UnlockChargePointEndpointResult : EndpointResponse, IUnlockChargePointEndpointResult
{
    public UnlockChargePointEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
