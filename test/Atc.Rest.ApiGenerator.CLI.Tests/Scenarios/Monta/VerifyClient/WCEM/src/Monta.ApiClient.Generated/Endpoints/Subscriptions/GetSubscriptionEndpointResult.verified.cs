...
public class GetSubscriptionEndpointResult : EndpointResponse, IGetSubscriptionEndpointResult
{
    public GetSubscriptionEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
