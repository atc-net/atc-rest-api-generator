...
public class DeleteTeamMemberProfileEndpointResult : EndpointResponse, IDeleteTeamMemberProfileEndpointResult
{
    public DeleteTeamMemberProfileEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
