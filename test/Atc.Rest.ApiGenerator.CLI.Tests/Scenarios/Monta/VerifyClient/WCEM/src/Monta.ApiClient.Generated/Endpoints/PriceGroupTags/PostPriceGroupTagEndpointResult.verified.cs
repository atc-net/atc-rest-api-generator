...
public class PostPriceGroupTagEndpointResult : EndpointResponse, IPostPriceGroupTagEndpointResult
{
    public PostPriceGroupTagEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
