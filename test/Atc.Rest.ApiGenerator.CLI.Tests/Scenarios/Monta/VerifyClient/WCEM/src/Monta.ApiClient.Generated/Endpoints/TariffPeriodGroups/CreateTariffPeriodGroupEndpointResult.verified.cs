...
public class CreateTariffPeriodGroupEndpointResult : EndpointResponse, ICreateTariffPeriodGroupEndpointResult
{
    public CreateTariffPeriodGroupEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
