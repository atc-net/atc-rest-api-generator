...
public class PostTeamMemberProfileEndpointResult : EndpointResponse, IPostTeamMemberProfileEndpointResult
{
    public PostTeamMemberProfileEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
