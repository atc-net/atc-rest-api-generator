...
public class GetWalletTransactionEndpointResult : EndpointResponse, IGetWalletTransactionEndpointResult
{
    public GetWalletTransactionEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public WalletTransaction OkContent
        => IsOk && ContentObject is WalletTransaction result
            ? result
