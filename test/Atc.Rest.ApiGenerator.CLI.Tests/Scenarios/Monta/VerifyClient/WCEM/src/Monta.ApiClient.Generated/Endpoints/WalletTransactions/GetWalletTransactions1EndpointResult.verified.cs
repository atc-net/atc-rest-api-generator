...
public class GetWalletTransactions1EndpointResult : EndpointResponse, IGetWalletTransactions1EndpointResult
{
    public GetWalletTransactions1EndpointResult(EndpointResponse response)
        : base(response)
    {
    }
