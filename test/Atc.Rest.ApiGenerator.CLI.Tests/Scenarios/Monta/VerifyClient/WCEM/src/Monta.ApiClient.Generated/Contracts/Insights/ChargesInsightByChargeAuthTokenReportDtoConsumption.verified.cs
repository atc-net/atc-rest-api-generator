...
/// <summary>
/// ChargesInsightByChargeAuthTokenReportDtoConsumption.
/// </summary>
[GeneratedCode("ApiGenerator", "x.x.x.x")]
public class ChargesInsightByChargeAuthTokenReportDtoConsumption
{
    /// <summary>
    ...
    public override string ToString()
        => $"{nameof(ChargeType)}: {ChargeType}, {nameof(TotalSessions)}: {TotalSessions}, {nameof(TotalKwh)}: {TotalKwh}, {nameof(TotalNetPrice)}: {TotalNetPrice}, {nameof(TotalVat)}: {TotalVat}, {nameof(TotalGrossPrice)}: {TotalGrossPrice}, {nameof(MemberCostGroupId)}: {MemberCostGroupId}, {nameof(MemberCostGroupName)}: {MemberCostGroupName}, {nameof(MemberCostGroupPrice)}: {MemberCostGroupPrice}";
}