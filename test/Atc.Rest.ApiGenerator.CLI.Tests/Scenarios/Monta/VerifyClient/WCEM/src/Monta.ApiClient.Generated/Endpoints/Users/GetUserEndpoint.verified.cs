...
//------------------------------------------------------------------------------
namespace Monta.ApiClient.Generated.Endpoints.Users;
...
public class GetUserEndpoint : IGetUserEndpoint
{
    ...
    public async Task<GetUserEndpointResult> ExecuteAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var requestBuilder = httpMessageFactory.FromTemplate("/api/v1/users/{userId}");
        ...
        return await responseBuilder.BuildResponseAsync(x => new GetUserEndpointResult(x), cancellationToken);
    }
}