...
public class GetPaymentTerminalsEndpoint : IGetPaymentTerminalsEndpoint
{
    private readonly IHttpClientFactory factory;
    private readonly IHttpMessageFactory httpMessageFactory;

    public GetPaymentTerminalsEndpoint(
    ...
    public async Task<GetPaymentTerminalsEndpointResult> ExecuteAsync(
        GetPaymentTerminalsParameters parameters,
        string httpClientName = "Monta-ApiClient",
        CancellationToken cancellationToken = default)
    {
        var client = factory.CreateClient(httpClientName);

        var requestBuilder = httpMessageFactory.FromTemplate("/api/v1/payment-terminals");
        requestBuilder.WithQueryParameter("page", parameters.Page);
        requestBuilder.WithQueryParameter("perPage", parameters.PerPage);
        requestBuilder.WithQueryParameter("serial", parameters.Serial);
