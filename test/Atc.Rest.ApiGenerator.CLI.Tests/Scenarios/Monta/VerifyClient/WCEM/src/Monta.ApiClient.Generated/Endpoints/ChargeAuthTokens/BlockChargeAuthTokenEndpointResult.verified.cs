...
public class BlockChargeAuthTokenEndpointResult : EndpointResponse, IBlockChargeAuthTokenEndpointResult
{
    public BlockChargeAuthTokenEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
