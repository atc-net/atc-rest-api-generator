...
public class AcceptTeamMemberJoinRequestEndpointResult : EndpointResponse, IAcceptTeamMemberJoinRequestEndpointResult
{
    public AcceptTeamMemberJoinRequestEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
