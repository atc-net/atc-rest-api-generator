...
public class UpdateTeamMemberProfileEndpointResult : EndpointResponse, IUpdateTeamMemberProfileEndpointResult
{
    public UpdateTeamMemberProfileEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
