...
public class GetTeamsEndpointResult : EndpointResponse, IGetTeamsEndpointResult
{
    public GetTeamsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageTeamDto OkContent
        => IsOk && ContentObject is MontaPageTeamDto result
            ? result
