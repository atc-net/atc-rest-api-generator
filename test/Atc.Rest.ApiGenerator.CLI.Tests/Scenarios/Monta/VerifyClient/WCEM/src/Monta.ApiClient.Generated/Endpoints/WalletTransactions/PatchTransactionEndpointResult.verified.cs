...
public class PatchTransactionEndpointResult : EndpointResponse, IPatchTransactionEndpointResult
{
    public PatchTransactionEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
