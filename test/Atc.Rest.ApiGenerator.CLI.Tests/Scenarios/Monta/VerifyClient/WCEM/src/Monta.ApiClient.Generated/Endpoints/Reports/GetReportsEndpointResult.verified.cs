...
public class GetReportsEndpointResult : EndpointResponse, IGetReportsEndpointResult
{
    public GetReportsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageReportDto OkContent
        => IsOk && ContentObject is MontaPageReportDto result
            ? result
