...
public class GetReportsEndpoint : IGetReportsEndpoint
{
    private readonly IHttpClientFactory factory;
    private readonly IHttpMessageFactory httpMessageFactory;

    public GetReportsEndpoint(
    ...
    public async Task<GetReportsEndpointResult> ExecuteAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var requestBuilder = httpMessageFactory.FromTemplate("/api/v1/reports");
        ...
        requestBuilder.WithQueryParameter("priority", parameters.Priority);

        using var requestMessage = requestBuilder.Build(HttpMethod.Get);
        using var response = await client.SendAsync(requestMessage, cancellationToken);

        var responseBuilder = httpMessageFactory.FromResponse(response);
        responseBuilder.AddSuccessResponse<MontaPageReportDto>(HttpStatusCode.OK);
        ...
        return await responseBuilder.BuildResponseAsync(x => new GetReportsEndpointResult(x), cancellationToken);
    }
}