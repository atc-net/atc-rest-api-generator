...
public class GetNestedTeamEndpoint : IGetNestedTeamEndpoint
{
    private readonly IHttpClientFactory factory;
    private readonly IHttpMessageFactory httpMessageFactory;

    public GetNestedTeamEndpoint(
    ...
    public async Task<GetNestedTeamEndpointResult> ExecuteAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await responseBuilder.BuildResponseAsync(x => new GetNestedTeamEndpointResult(x), cancellationToken);
    }
}