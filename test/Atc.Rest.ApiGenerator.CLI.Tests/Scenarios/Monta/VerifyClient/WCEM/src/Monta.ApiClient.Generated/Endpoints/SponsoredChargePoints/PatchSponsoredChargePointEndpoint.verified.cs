...
public class PatchSponsoredChargePointEndpoint : IPatchSponsoredChargePointEndpoint
{
    private readonly IHttpClientFactory factory;
    private readonly IHttpMessageFactory httpMessageFactory;

    public PatchSponsoredChargePointEndpoint(
    ...
    public async Task<PatchSponsoredChargePointEndpointResult> ExecuteAsync(
