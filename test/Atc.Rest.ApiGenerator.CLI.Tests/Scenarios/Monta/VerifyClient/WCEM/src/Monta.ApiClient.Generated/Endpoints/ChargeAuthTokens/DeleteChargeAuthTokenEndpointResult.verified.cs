...
public class DeleteChargeAuthTokenEndpointResult : EndpointResponse, IDeleteChargeAuthTokenEndpointResult
{
    public DeleteChargeAuthTokenEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
