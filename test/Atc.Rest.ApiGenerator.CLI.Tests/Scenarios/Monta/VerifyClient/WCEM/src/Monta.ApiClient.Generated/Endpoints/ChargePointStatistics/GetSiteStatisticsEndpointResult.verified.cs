...
public class GetSiteStatisticsEndpointResult : EndpointResponse, IGetSiteStatisticsEndpointResult
{
    public GetSiteStatisticsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
