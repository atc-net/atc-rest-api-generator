...
public class DeleteTeamEndpoint : IDeleteTeamEndpoint
{
    private readonly IHttpClientFactory factory;
    private readonly IHttpMessageFactory httpMessageFactory;

    public DeleteTeamEndpoint(
    ...
    public async Task<DeleteTeamEndpointResult> ExecuteAsync(
        DeleteTeamParameters parameters,
