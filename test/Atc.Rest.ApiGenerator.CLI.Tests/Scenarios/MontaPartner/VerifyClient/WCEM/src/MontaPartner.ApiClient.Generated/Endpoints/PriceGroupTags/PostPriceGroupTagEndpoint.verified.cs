...
public class PostPriceGroupTagEndpoint : IPostPriceGroupTagEndpoint
{
    private readonly IHttpClientFactory factory;
    private readonly IHttpMessageFactory httpMessageFactory;

    public PostPriceGroupTagEndpoint(
    ...
    public async Task<PostPriceGroupTagEndpointResult> ExecuteAsync(
        PostPriceGroupTagParameters parameters,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await responseBuilder.BuildResponseAsync(x => new PostPriceGroupTagEndpointResult(x), cancellationToken);
    }
}