...
public class ApplyPriceGroupEndpointResult : EndpointResponse, IApplyPriceGroupEndpointResult
{
    public ApplyPriceGroupEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
