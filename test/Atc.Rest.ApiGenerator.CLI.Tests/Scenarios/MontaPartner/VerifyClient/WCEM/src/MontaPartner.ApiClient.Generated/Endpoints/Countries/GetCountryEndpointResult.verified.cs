...
public class GetCountryEndpointResult : EndpointResponse, IGetCountryEndpointResult
{
    public GetCountryEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public Country OkContent
        => IsOk && ContentObject is Country result
            ? result
