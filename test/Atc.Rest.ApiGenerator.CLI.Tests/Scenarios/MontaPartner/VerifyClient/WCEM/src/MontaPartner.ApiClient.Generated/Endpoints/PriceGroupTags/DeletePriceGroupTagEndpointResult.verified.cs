...
public class DeletePriceGroupTagEndpointResult : EndpointResponse, IDeletePriceGroupTagEndpointResult
{
    public DeletePriceGroupTagEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
