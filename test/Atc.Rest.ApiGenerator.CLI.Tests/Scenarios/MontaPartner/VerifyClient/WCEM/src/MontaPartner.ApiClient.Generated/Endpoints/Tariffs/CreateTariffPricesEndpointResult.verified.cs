...
public class CreateTariffPricesEndpointResult : EndpointResponse, ICreateTariffPricesEndpointResult
{
    public CreateTariffPricesEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
