...
public class DeleteTeamMemberEndpointResult : EndpointResponse, IDeleteTeamMemberEndpointResult
{
    public DeleteTeamMemberEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
