...
public class UpdateWebhookConfigEndpointResult : EndpointResponse, IUpdateWebhookConfigEndpointResult
{
    public UpdateWebhookConfigEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public WebhookConfig OkContent
        => IsOk && ContentObject is WebhookConfig result
            ? result
