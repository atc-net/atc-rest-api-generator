...
public class GetTariffRecurringPeriodsEndpointResult : EndpointResponse, IGetTariffRecurringPeriodsEndpointResult
{
    public GetTariffRecurringPeriodsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public PageTariffRecurringPeriodDto OkContent
        => IsOk && ContentObject is PageTariffRecurringPeriodDto result
            ? result
