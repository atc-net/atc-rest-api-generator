...
public class UpdatePriceGroupEndpointResult : EndpointResponse, IUpdatePriceGroupEndpointResult
{
    public UpdatePriceGroupEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
