...
public class GetChargePointBrandEndpointResult : EndpointResponse, IGetChargePointBrandEndpointResult
{
    public GetChargePointBrandEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public ChargePointBrand OkContent
        => IsOk && ContentObject is ChargePointBrand result
            ? result
