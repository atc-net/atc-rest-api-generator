...
public class GetPaymentTerminalEndpointResult : EndpointResponse, IGetPaymentTerminalEndpointResult
{
    public GetPaymentTerminalEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public PaymentTerminal OkContent
        => IsOk && ContentObject is PaymentTerminal result
            ? result
