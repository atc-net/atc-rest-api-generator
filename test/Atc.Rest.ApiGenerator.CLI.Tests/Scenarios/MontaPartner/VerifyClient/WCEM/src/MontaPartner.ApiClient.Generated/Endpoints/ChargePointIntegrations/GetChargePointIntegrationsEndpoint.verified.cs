...
public class GetChargePointIntegrationsEndpoint : IGetChargePointIntegrationsEndpoint
{
    private readonly IHttpClientFactory factory;
    private readonly IHttpMessageFactory httpMessageFactory;

    public GetChargePointIntegrationsEndpoint(
    ...
    public async Task<GetChargePointIntegrationsEndpointResult> ExecuteAsync(
        GetChargePointIntegrationsParameters parameters,
