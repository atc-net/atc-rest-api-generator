...
public class GetTariffRecurringPeriodEndpointResult : EndpointResponse, IGetTariffRecurringPeriodEndpointResult
{
    public GetTariffRecurringPeriodEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
