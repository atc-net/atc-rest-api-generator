...
public class GetWebhookConfigEndpointResult : EndpointResponse, IGetWebhookConfigEndpointResult
{
    public GetWebhookConfigEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
