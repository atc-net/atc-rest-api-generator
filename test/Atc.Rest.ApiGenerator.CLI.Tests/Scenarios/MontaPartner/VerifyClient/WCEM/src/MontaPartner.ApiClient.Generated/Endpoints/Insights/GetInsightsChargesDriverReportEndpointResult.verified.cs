...
public class GetInsightsChargesDriverReportEndpointResult : EndpointResponse, IGetInsightsChargesDriverReportEndpointResult
{
    public GetInsightsChargesDriverReportEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageChargesInsightDriverReportDto OkContent
        => IsOk && ContentObject is MontaPageChargesInsightDriverReportDto result
            ? result
