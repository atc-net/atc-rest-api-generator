...
public class GetWalletsEndpointResult : EndpointResponse, IGetWalletsEndpointResult
{
    public GetWalletsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageWalletDto OkContent
        => IsOk && ContentObject is MontaPageWalletDto result
            ? result
