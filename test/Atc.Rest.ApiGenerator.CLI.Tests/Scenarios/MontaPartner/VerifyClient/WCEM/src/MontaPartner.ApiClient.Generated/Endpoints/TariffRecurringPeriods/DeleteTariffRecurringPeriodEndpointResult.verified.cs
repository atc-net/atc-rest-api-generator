...
public class DeleteTariffRecurringPeriodEndpointResult : EndpointResponse, IDeleteTariffRecurringPeriodEndpointResult
{
    public DeleteTariffRecurringPeriodEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
