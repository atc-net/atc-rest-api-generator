...
public class GetAllTariffsEndpointResult : EndpointResponse, IGetAllTariffsEndpointResult
{
    public GetAllTariffsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public IEnumerable<TariffDto> OkContent
        => IsOk && ContentObject is IEnumerable<TariffDto> result
            ? result
