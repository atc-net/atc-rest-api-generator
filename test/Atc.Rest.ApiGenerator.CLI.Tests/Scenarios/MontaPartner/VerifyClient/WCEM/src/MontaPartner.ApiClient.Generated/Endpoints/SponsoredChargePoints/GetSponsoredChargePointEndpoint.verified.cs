...
public class GetSponsoredChargePointEndpoint : IGetSponsoredChargePointEndpoint
{
    private readonly IHttpClientFactory factory;
    private readonly IHttpMessageFactory httpMessageFactory;

    public GetSponsoredChargePointEndpoint(
    ...
    public async Task<GetSponsoredChargePointEndpointResult> ExecuteAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await responseBuilder.BuildResponseAsync(x => new GetSponsoredChargePointEndpointResult(x), cancellationToken);
    }
}