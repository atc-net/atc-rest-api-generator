...
public class GetWebhookEntries1EndpointResult : EndpointResponse, IGetWebhookEntries1EndpointResult
{
    public GetWebhookEntries1EndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public WebhookEntry OkContent
        => IsOk && ContentObject is WebhookEntry result
            ? result
