...
public class GetPlansEndpointResult : EndpointResponse, IGetPlansEndpointResult
{
    public GetPlansEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPagePlanDto OkContent
        => IsOk && ContentObject is MontaPagePlanDto result
            ? result
