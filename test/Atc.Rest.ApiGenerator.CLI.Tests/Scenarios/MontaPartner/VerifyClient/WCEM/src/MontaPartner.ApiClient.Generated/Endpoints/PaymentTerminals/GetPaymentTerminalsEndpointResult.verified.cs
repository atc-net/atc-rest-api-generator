...
public class GetPaymentTerminalsEndpointResult : EndpointResponse, IGetPaymentTerminalsEndpointResult
{
    public GetPaymentTerminalsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPagePaymentTerminalDto OkContent
        => IsOk && ContentObject is MontaPagePaymentTerminalDto result
            ? result
