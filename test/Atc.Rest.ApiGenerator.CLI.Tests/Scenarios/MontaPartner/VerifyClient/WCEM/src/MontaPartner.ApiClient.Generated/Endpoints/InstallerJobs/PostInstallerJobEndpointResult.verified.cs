...
public class PostInstallerJobEndpointResult : EndpointResponse, IPostInstallerJobEndpointResult
{
    public PostInstallerJobEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
