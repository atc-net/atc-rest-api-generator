...
public class PatchTeamMemberEndpointResult : EndpointResponse, IPatchTeamMemberEndpointResult
{
    public PatchTeamMemberEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
