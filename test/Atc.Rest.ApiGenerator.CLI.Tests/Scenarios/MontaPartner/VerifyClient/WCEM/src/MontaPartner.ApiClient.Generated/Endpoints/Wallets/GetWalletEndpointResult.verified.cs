...
public class GetWalletEndpointResult : EndpointResponse, IGetWalletEndpointResult
{
    public GetWalletEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public Wallet OkContent
        => IsOk && ContentObject is Wallet result
            ? result
