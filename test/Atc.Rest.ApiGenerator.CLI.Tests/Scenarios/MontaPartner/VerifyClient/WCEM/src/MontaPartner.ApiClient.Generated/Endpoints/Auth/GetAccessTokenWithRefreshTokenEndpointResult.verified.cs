...
public class GetAccessTokenWithRefreshTokenEndpointResult : EndpointResponse, IGetAccessTokenWithRefreshTokenEndpointResult
{
    public GetAccessTokenWithRefreshTokenEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
