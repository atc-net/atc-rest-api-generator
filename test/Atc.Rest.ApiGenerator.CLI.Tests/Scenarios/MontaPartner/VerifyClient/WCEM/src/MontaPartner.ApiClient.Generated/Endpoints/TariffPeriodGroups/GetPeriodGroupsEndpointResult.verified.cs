...
public class GetPeriodGroupsEndpointResult : EndpointResponse, IGetPeriodGroupsEndpointResult
{
    public GetPeriodGroupsEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public IEnumerable<TariffPeriodGroup> OkContent
        => IsOk && ContentObject is IEnumerable<TariffPeriodGroup> result
            ? result
