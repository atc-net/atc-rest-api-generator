...
public class GetConnectorEndpointResult : EndpointResponse, IGetConnectorEndpointResult
{
    public GetConnectorEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public ChargePointConnector OkContent
        => IsOk && ContentObject is ChargePointConnector result
            ? result
