...
public class GetSponsoredChargePointsParameters
{
    /// <summary>
    ...
    public override string ToString()
        => $"{nameof(Page)}: {Page}, {nameof(PerPage)}: {PerPage}, {nameof(ChargePointId)}: {ChargePointId}, {nameof(TeamId)}: {TeamId}, {nameof(IncludeDeleted)}: {IncludeDeleted}";
}