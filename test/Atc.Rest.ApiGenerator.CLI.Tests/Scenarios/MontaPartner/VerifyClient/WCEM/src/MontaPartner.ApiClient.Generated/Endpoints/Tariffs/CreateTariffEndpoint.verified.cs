...
public class CreateTariffEndpoint : ICreateTariffEndpoint
{
    private readonly IHttpClientFactory factory;
    private readonly IHttpMessageFactory httpMessageFactory;

    public CreateTariffEndpoint(
    ...
    public async Task<CreateTariffEndpointResult> ExecuteAsync(
        CreateTariffParameters parameters,
