...
public class GetChargePointIntegrationEndpointResult : EndpointResponse, IGetChargePointIntegrationEndpointResult
{
    public GetChargePointIntegrationEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
