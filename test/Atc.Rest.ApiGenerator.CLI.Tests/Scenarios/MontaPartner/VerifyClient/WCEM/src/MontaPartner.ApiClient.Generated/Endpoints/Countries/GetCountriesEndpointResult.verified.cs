...
public class GetCountriesEndpointResult : EndpointResponse, IGetCountriesEndpointResult
{
    public GetCountriesEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public MontaPageCountryDto OkContent
        => IsOk && ContentObject is MontaPageCountryDto result
            ? result
