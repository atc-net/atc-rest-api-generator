...
public class GetTariffEndpointResult : EndpointResponse, IGetTariffEndpointResult
{
    public GetTariffEndpointResult(EndpointResponse response)
        : base(response)
    {
    }
    ...
    public FullTariff OkContent
        => IsOk && ContentObject is FullTariff result
            ? result
