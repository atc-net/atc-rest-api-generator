...
public class PatchOrdersIdParameters
{
    ...
    /// </summary>
    [Required]
    public string X-correlation-id { get; set; }
    ...
    public override string ToString()
        => $"{nameof(Id)}: {Id}, {nameof(MyTestHeader)}: {MyTestHeader}, {nameof(MyTestHeaderBool)}: {MyTestHeaderBool}, {nameof(MyTestHeaderInt)}: {MyTestHeaderInt}, {nameof(X-correlation-id)}: {X-correlation-id}, {nameof(Request)}: ({Request})";
}