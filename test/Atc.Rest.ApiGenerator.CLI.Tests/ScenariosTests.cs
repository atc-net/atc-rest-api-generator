...
public class ScenariosTests : ScenarioIntegrationTestBase, IAsyncLifetime
{
    ...
    [InlineData("ExampleWithAllRespTypes")]
    ...
    [InlineData("ExampleWithAllRespTypes", AspNetOutputType.Mvc, false)]
    [InlineData("ExampleWithAllRespTypes", AspNetOutputType.Mvc, true)]
    ...
    [InlineData("ExampleWithAllRespTypes", false)]
    [InlineData("ExampleWithAllRespTypes", true)]
