...
public class EventArgsController : ControllerBase
{
    ...
    /// </summary>
    [HttpGet]
    [ProducesResponseType(typeof(IEnumerable<DemoSampleApi.Api.Generated.Contracts.EventArgs.EventArgs>), StatusCodes.Status200OK)]
    ...
    /// </summary>
    [HttpGet("{id}")]
    [ProducesResponseType(typeof(DemoSampleApi.Api.Generated.Contracts.EventArgs.EventArgs), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status401Unauthorized)]
    [ProducesResponseType(StatusCodes.Status403Forbidden)]
