...
public class ContentGeneratorServerClientModel : IContentGenerator
{
    ...
    private readonly ContentGeneratorServerClientModelParameters parameters;

    public ContentGeneratorServerClientModel(
        ...
        ContentGeneratorServerClientModelParameters parameters)
    {
    ...
    private static void AppendPropertyAttributes(
        StringBuilder sb,
        ContentGeneratorServerClientModelParametersProperty item)
    {
        if (item.IsRequired)
        {
    ...
    private static void AppendMethodToStringContent(
        StringBuilder sb,
        IList<ContentGeneratorServerClientModelParametersProperty> items)
    {
