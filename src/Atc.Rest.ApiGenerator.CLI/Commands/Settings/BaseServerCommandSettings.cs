...
public class BaseServerCommandSettings : BaseGenerateCommandSettings
{
    ...
    [AspNetOutputType(Default = Contracts.AspNetOutputType.Mvc, Prefix = "Set AspNet output type for the generated api")]
    ...
    [SwaggerThemeMode(Default = Contracts.SwaggerThemeMode.Default, Prefix = "Set Swagger theme for the hosting api")]
